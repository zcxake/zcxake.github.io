...
function createCircle(e, t) { var a = {}; return a.x = e, a.y = t, a.color = "#eee", a.radius = .1, a.alpha = .5, a.lineWidth = 6, a.draw = function() { ctx.globalAlpha = a.alpha, ctx.beginPath(), ctx.arc(a.x, a.y, a.radius, 0, 2 * Math.PI, !0), ctx.lineWidth = a.lineWidth, ctx.strokeStyle = a.color, ctx.stroke(), ctx.globalAlpha = 1 }, a }
...
if (canvasEl) {
    var ctx = canvasEl.getContext("2d"),
        ...
        pointerY = 0,
        tap = "mousedown",
        colors = ["#e3b4b8", "#57c3c2", "#3170a7", "#f7e8aa"],
